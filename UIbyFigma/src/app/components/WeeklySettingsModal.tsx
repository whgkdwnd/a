...
export function WeeklySettingsModal({ isOpen, onClose }: WeeklySettingsModalProps) {
          ...
          <div className="bg-[#5A6475] rounded-lg p-4 border-2 border-gray-600">
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3 cursor-pointer group">
                ...
                />
                <span className="text-sm text-gray-200 group-hover:text-white transition-colors">완료한 컨텐츠 숨기기</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer group">
                <input 
                  type="checkbox" 
                  ...
                  className="w-4 h-4 rounded border-2 border-gray-500 bg-gray-600 checked:bg-cyan-400 checked:border-cyan-400 cursor-pointer"
                />
                <span className="text-sm text-gray-200 group-hover:text-white transition-colors">카테고리별 그룹화</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer group">
                <input 
                  type="checkbox" 
                  ...
                  className="w-4 h-4 rounded border-2 border-gray-500 bg-gray-600 checked:bg-cyan-400 checked:border-cyan-400 cursor-pointer"
                />
                <span className="text-sm text-gray-200 group-hover:text-white transition-colors">진행도 표시</span>
              </label>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3 cursor-pointer group">
                <input 
                  ...
                  className="w-4 h-4 rounded border-2 border-gray-500 bg-gray-600 checked:bg-cyan-400 checked:border-cyan-400 cursor-pointer"
                />
                <span className="text-sm text-gray-200 group-hover:text-white transition-colors">주간 초기화 알림 (목요일)</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer group">
                <input 
                  type="checkbox" 
                  className="w-4 h-4 rounded border-2 border-gray-500 bg-gray-600 checked:bg-cyan-400 checked:border-cyan-400 cursor-pointer"
                />
                <span className="text-sm text-gray-200 group-hover:text-white transition-colors">미완료 컨텐츠 알림</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer group">
                <input 
                  type="checkbox" 
                  className="w-4 h-4 rounded border-2 border-gray-500 bg-gray-600 checked:bg-cyan-400 checked:border-cyan-400 cursor-pointer"
                />
                <span className="text-sm text-gray-200 group-hover:text-white transition-colors">주말 리마인더</span>
              </label>
            </div>
          </div>
